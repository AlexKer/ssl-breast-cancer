...
def train_downstream(model, optimizer, train_loader, test_loader, external_loader, epochs : int):
    model.train()

    train_epoch_losses, val_epoch_losses, test_epoch_losses = [], [], []
    train_epoch_auc, val_epoch_auc, test_epoch_auc = [], [], []
    ...
    return best_epoch, best_accuracy, best_auc, best_f1, best_sensitivity, best_specificity
